            ...
            >
              ...
              <div className="flex justify-between items-center mb-1 text-base">
                <span className="text-black">
                  {perPerson.toLocaleString()} Br x {people} Person
                </span>
              ...
              <div className="flex justify-between items-center mb-1 text-sm">
                ...
                <span className="text-gray-400">{serviceFee}Br</span>
              </div>
              <div className="flex justify-between items-center mb-2 text-sm">
                <span className="text-gray-400">Processing fee</span>
                <span className="text-gray-400">{processingFee}Br</span>
              </div>
              ...
              <div className="flex items-start gap-2 mt-2">
                ...
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setValue("agreed", !!checked, { shouldDirty: true, shouldValidate: true })
                  }
                />
