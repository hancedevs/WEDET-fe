...
export function LoginPage() {
  ...
  const handleNavigateToBussinessSignup = () => router.push("/auth/BussinesRegistration");
  const handleNavigateToforgotpassword = () => router.push("/auth/forgotpassword");
      ...
      <div className="flex-1 bg-white rounded-t-3xl px-6 py-8 absolute top-30 w-full  border-t-2 ">
        <div className="max-w-sm mx-auto">
          ...
          <h1
            ...
            style={{ fontFamily: "'Century Gothic'", fontWeight: 700 }}
          >
