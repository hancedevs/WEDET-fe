    ...
    <div className="flex flex-col gap-5">
      <div className="flex items-center justify-between mt-4 mb-3 px-3">
        <div className="flex gap-1 items-center">
          ...
          <div>
            <p className="text-[11px] text-gray-600">Good morning,user</p>
            <h2 className="text-md font-bold text-gray-900">Discover and go</h2>
          </div>
        </div>
        <div className="flex items-center gap-5">
          <div className="relative inline-block">
            <BellDot className="h-6 w-6 sm:h-6 sm:w-6" strokeWidth={1} />
