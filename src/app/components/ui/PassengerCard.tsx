...
import { Passenger } from "@/app/types/type"; // or use the interface shown above
    ...
    <article className="rounded-[24px] border border-[#2AD180] bg-white px-3 py-3 shadow-[0_2px_10px_rgba(0,0,0,0.06)]">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="font-semibold leading-tight text-[#111]">{p.name}</div>
      ...
      <div className="relative mt-3 rounded-[18px] bg-[#F2F8F5] px-3 py-3">
        ...
        <div className="space-y-2 pr-28">
          <div className="flex items-start gap-2">
            ...
            <span className="text-sm text-[#2B2B2B]">{p.location}</span>
          </div>
      ...
      {p.note && (
        <>
          <div className="mt-3 text-[12px] text-[#28B872] font-medium">Note:</div>
