...
function CurvedLeftIcon({ size = 16, className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size}
         className={className} fill="currentColor" aria-hidden="true" {...props}>
...
export default function StepController({
  ...
  return (
    <div className={"mt-6 " + className}>
      <div className={"w-full flex items-center " + (showPrev ? "justify-between" : "justify-center")}>
        {showPrev && (
          <button
            type="button"
            onClick={goPrev}
          ...
          >
            ...
            <span className="w-full text-center select-none pointer-events-none">Previous</span>
          </button>
        )}
        ...
        <button
          ...
          aria-label="Next"
        >
          <span className="w-full text-center select-none pointer-events-none">Next</span>
