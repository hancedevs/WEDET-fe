    ...
    <div className="flex justify-center items-center space-x-2 my-6">
      ...
      {startPage > 1 && (
        <>
          <button
            ...
            className={`px-3 py-1 rounded-full ${1 === currentPage ? 'bg-green-600 text-white' : 'text-green-600 hover:bg-green-100'}`}
          >
            1
          </button>
      ...
      {pages.map(page => (
        <button
          ...
          className={`px-3 py-1 rounded-full ${page === currentPage ? 'bg-green-600 text-white' : 'text-green-600 hover:bg-green-100'}`}
        >
          {page}
        </button>
      ))}
      ...
      {endPage < totalPages && (
        <>
          ...
          <button
            ...
            className={`px-3 py-1 rounded-full ${totalPages === currentPage ? 'bg-green-600 text-white' : 'text-green-600 hover:bg-green-100'}`}
          >
            {totalPages}
          </button>
        </>
      ...
      <div className="w-full px-4 py pb-20">
        <div className="flex items-center mb-6 mt-4 pr-2">
          ...
          <div className="ml-2">
            ...
            <p className="text-xs">Good morning, {businessProfile?.business_name || user?.user_metadata?.business_name || 'user'}</p>
        ...
        {/* Trips Section */}
        <div id="trips-section" className="flex justify-between items-center mb-6 w-full">
