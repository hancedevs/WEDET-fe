...
const TripCard: React.FC<TripCardProps> = ({
  ...
  <div className="relative bg-white rounded-2xl shadow p-4 flex justify-between items-center w-full mb-8">
    <div className="flex-1 mr-4">
      <span
        className="absolute -top-4 right-6 text-xs text-black px-3 py-1 rounded-full font-medium"
      ...
      <div className="w-full px-4 pb-20">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 w-full">
          ...
          <div className="bg-white rounded-2xl shadow p-4 flex items-center w-full">
            ...
            <div>
              <p className="text-sm text-gray-500">Upcoming Trip</p>
              <h2 className="text-base font-semibold">Wenchi</h2>
          ...
          <div className="bg-[#F3FCFB] rounded-2xl shadow p-4 flex items-center w-full">
